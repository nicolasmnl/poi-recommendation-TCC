...
if __name__ == '__main__':
    # dst_dir = r'dataset/NYC/original'
    dst_dir = r'dataset/NYC/original_reduced'
    # dst_dir = r'dataset/NYC/cat_mapping'
    # dst_dir = r'dataset/NYC/cat_mapping_reduced'

    # Build POI checkin trajectory graph
    # train_df = pd.read_csv(os.path.join(dst_dir, 'NYC_train.csv'))
    train_df = pd.read_csv(os.path.join(dst_dir, 'NYC_train_original_reduced.csv'))
    # train_df = pd.read_csv(os.path.join(dst_dir, 'NYC_train_cat_mapping.csv'))
